 ...
 * by applying overrides, reverting / updating overridables, and regenerating IDs.
 ...
 * - Updates overridable props metadata when the applied override is exposed further
 *
 * @param element   - The component's root element to resolve
 * @param overrides - Array of overrides from the component instance
 * @return A new element data with all overrides applied and fresh IDs
 */
